  ...
  return (
    <main className="min-h-screen overflow-hidden bg-black text-white">
      ...
      <section id="about" className="mx-auto max-w-6xl px-6 py-24">
        <h2 className="mb-8 text-center text-5xl font-bold">About NOVASTACK</h2>
      ...
      <section id="internship" className="mx-auto max-w-6xl px-6 py-24">
        <div className="rounded-3xl border border-purple-500/20 bg-purple-500/10 p-10 backdrop-blur-xl">
          ...
          <a
            href="#contact"
            className="mt-8 inline-block rounded-full bg-white px-8 py-4 font-bold text-black transition hover:scale-105 hover:bg-cyan-200"
          >
            Apply Now
          </a>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        <h2 className="mb-14 text-center text-5xl font-bold">Why Choose NOVASTACK</h2>
      ...
      <motion.a
        href="https://wa.me/917479772672?text=Hi%20NOVASTACK%2C%20I%20want%20to%20know%20more%20about%20AI%20automation."
        target="_blank"
