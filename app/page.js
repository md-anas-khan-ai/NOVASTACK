    ...
    <main className="min-h-screen overflow-hidden bg-black text-white">
      ...
      <nav className="fixed top-0 z-50 w-full border-b border-white/10 bg-black/40 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5">
          <div className="flex items-center gap-3">
            ...
            />
            <h1 className="text-2xl font-black tracking-wider">NovaStacks</h1>
          </div>

          <div className="hidden gap-8 text-sm md:flex">
            <a href="#about" className="hover:text-cyan-300">About</a>
            <a href="#services" className="hover:text-cyan-300">Services</a>
            <a href="#internship" className="hover:text-cyan-300">Internship</a>
      ...
      <section className="flex min-h-screen flex-col items-center justify-center px-6 text-center">
        ...
        <p className="mt-8 max-w-2xl text-lg text-gray-300 md:text-xl">
          NovaStacks builds AI Agents, AI Automation systems, Chatbots, Voice
          Assistants and practical AI solutions for students and businesses.
        </p>

        <div className="mt-10 flex flex-col gap-4 sm:flex-row">
          <a href="#contact" className="rounded-full bg-white px-8 py-4 font-bold text-black transition hover:scale-105 hover:bg-cyan-200 hover:shadow-[0_0_40px_rgba(34,211,238,0.6)]">
            Start Automation
          </a>
          <a href="#internship" className="rounded-full border border-white/20 px-8 py-4 font-bold transition hover:scale-105 hover:bg-white/10">
      ...
      <section id="about" className="mx-auto max-w-6xl px-6 py-24">
        <h2 className="mb-8 text-center text-5xl font-bold">About NovaStacks</h2>
        <p className="text-center text-lg leading-8 text-gray-300">
          NovaStacks is an AI Automation and AI Learning startup focused on
      ...
      <section id="services" className="mx-auto max-w-7xl px-6 py-24">
        <h2 className="mb-14 text-center text-5xl font-bold">Our Services</h2>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            <motion.div
              ...
              key={title}
              className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl transition hover:border-cyan-400/40 hover:shadow-[0_0_40px_rgba(34,211,238,0.2)]"
            >
              <Icon size={45} className="mb-6 text-cyan-300" />
      ...
      <section id="internship" className="mx-auto max-w-6xl px-6 py-24">
        <div className="rounded-3xl border border-purple-500/20 bg-purple-500/10 p-10 backdrop-blur-xl shadow-[0_0_60px_rgba(168,85,247,0.2)]">
          <h2 className="text-5xl font-bold">Free AI/ML Internship Program</h2>
          <p className="mt-6 text-lg leading-8 text-gray-300">
            Work on real AI projects, learn practical AI skills, build portfolio
            projects and receive a verified certificate.
          </p>
        </div>
      </section>

      <section id="projects" className="mx-auto max-w-7xl px-6 py-24">
        <h2 className="mb-14 text-center text-5xl font-bold">AI Projects Showcase</h2>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            <motion.div
              ...
              className="rounded-3xl border border-white/10 bg-gradient-to-br from-cyan-500/10 to-purple-500/10 p-8 backdrop-blur-xl transition hover:shadow-[0_0_40px_rgba(168,85,247,0.3)]"
            >
      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        <h2 className="mb-14 text-center text-5xl font-bold">Why Choose NovaStacks</h2>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <motion.div
              whileHover={{ y: -10, scale: 1.02 }}
              key={title}
              className="rounded-3xl border border-white/10 bg-white/5 p-8 text-center backdrop-blur-xl transition hover:shadow-[0_0_40px_rgba(34,211,238,0.2)]"
            >
              <Icon size={50} className="mx-auto mb-5 text-purple-300" />
      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        <h2 className="mb-14 text-center text-5xl font-bold">Testimonials</h2>
      ...
      <section id="contact" className="mx-auto max-w-6xl px-6 py-24">
        <h2 className="mb-10 text-center text-5xl font-bold">Contact Us</h2>

        <div className="grid gap-8 md:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl">
            <input className="mb-4 w-full rounded-xl bg-white/10 p-4 outline-none" placeholder="Your Name" />
            <input className="mb-4 w-full rounded-xl bg-white/10 p-4 outline-none" placeholder="Email" />
            <textarea className="mb-4 h-40 w-full rounded-xl bg-white/10 p-4 outline-none" placeholder="Message" />
            <button className="w-full rounded-xl bg-white py-4 font-bold text-black transition hover:bg-cyan-200 hover:shadow-[0_0_40px_rgba(34,211,238,0.6)]">
              Send Message
            </button>
          </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl">
            ...
            <div className="mt-8 space-y-4 text-lg text-gray-300">
              <p>Email: novastacks@gmail.com</p>
